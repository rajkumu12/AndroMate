 ...
 */
public class Top_new_Frag extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view=inflater.inflate(R.layout.fragment_top_new_, container, false);


        recy_toprated=view.findViewById(R.id.recy_top_new);
