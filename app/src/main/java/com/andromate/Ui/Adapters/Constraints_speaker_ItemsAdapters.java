...
public class Constraints_speaker_ItemsAdapters extends RecyclerView.Adapter<Constraints_speaker_ItemsAdapters.ViewHolder> {

    private Context context;
    private List<TriggerItemModel> arrayList;

    public Constraints_speaker_ItemsAdapters(Context context, List<TriggerItemModel> arrayList) {
    ...
    @NonNull
    @Override
    public Constraints_speaker_ItemsAdapters.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.triggeritem_ui, parent, false);
        return new Constraints_speaker_ItemsAdapters.ViewHolder(v);
    }

    @Override
    public void onBindViewHolder(@NonNull final Constraints_speaker_ItemsAdapters.ViewHolder holder, final int position) {
